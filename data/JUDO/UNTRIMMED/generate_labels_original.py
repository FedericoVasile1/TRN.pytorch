...
def main(args):
    ...
    with open(args.labels_file, encoding="utf16") as csv_file:
        ...
        for row in csv_reader:
            ...
            # according to labels_file, all actions are 10 seconds long
            DURATION_ACTION = 10000
            start_time = int(row[column_time])
            end_time = start_time + DURATION_ACTION
...
if __name__ == '__main__':
    ...
    parser.add_argument('--target_labels_dir', default='target_frames_25fps_original', type=str)
