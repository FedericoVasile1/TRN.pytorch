...
from lib.models.autoencoder.convolution_lstm import ConvLSTM
...
class VideoAutoencoderLSTM(nn.Module):
    def __init__(self, args):
        ...
        self.conv_decoder = nn.Sequential(OrderedDict([
            ...
            ('nonl1', nn.Tanh()),
            ('deconv2',
             nn.ConvTranspose2d(in_channels=128, out_channels=self.in_channels, kernel_size=11, stride=4, padding=0)),
            ('nonl2', nn.Tanh())
        ]))
