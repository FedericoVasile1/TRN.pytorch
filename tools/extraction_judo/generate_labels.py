...
def main(args):
    ...
    with open(os.path.join(args.data_root, args.labels_file), encoding="utf16") as csv_file:
        ...
        for row in csv_reader:
            ...
            DELAY = 5000
            time = int(row[column_time]) + DELAY
            ...
            start_frame = milliseconds_to_numframe(start_time, fps=args.fps) - 1
            end_frame = milliseconds_to_numframe(end_time, fps=args.fps) - 1
